        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4 mb-6">
              {[
                { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/doks.studio/?hl=bg" },
              ...
              <a href="https://www.tiktok.com/@doks.studio" aria-label="TikTok" target="_blank" rel="noopener noreferrer" className="text-chalk/25 hover:text-chalk transition-colors duration-300">
