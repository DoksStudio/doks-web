...
const recommended = [
  ...
  { name: "Lisbon Slim Trouser", category: "Смарт Кежуъл", price: "390 €", href: "/collection/smart-casual/lisbon-slim-trouser", image: "/Web Photos/Photo6.jpg" },
];
    ...
    <div className="bg-chalk min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center py-24 md:py-28 px-6 text-center border-b border-obsidian/8">
        ...
        <p className="font-sans text-stone text-sm font-light mb-10 max-w-xs leading-relaxed">
          Разгледайте нашата колекция и намерете перфектния артикул за вас.
        </p>
        <Link
          href="/collection"
